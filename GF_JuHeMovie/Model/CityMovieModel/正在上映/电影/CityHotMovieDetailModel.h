...
@interface CityHotMovieDetailModel : BaseModel

@property (nonatomic,copy) NSString *tvTitle, *gradeNum, *iconlinkUrl, *iconaddress, *m_iconlinkUrl, *grade, *subHead;

@property (nonatomic,retain) NSDictionary *director, *star, *playDate, *type, *story, *more;
